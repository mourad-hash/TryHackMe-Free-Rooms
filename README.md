# TryHackMe Free Rooms (it cost $0)

Hey Friends 👋  
Here's a list of **390+ Free TryHackMe rooms** to start learning hacking.  
I have arranged & compiled them according to different topics so you can start hacking right now!

All the rooms herein are **absolutely free**.  
**ATTACK!!** 💥

## Maintainer

This repository is maintained by **mourad-hash**  
For any suggestion, new free room you found, correction or feedback — feel free to reach out to me:

- **GitHub**: [mourad-hash](https://github.com/mourad-hash)

## Advice for everyone

**Practice, Practice and Practice...!**  
It'll all finally fall into place.  
**No shortcut folks :)**

## How you can communicate with me

If you genuinely feel like this project helped you a lot,  
you can always send your appreciation (or just say hi) 😄

- **WhatsApp**: +201022593960  
- **Email**: ahmedmohammedmourad@gmail.com

Any message is welcome — thank you, funny meme, success story, question, suggestion... everything counts! ❤️
